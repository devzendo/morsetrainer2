...
public class Main {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			final PartyMorseCharacterIterator it = new PartyMorseCharacterIteratorFactory(options.length, options.source, options.sourceChars, options.sourceWords, options.play, options.playString, callsignGenerator, qsoGenerator).create();
